---
title: API Endpoints
description: Query information about the NexaDash installation
tags:
  - Integration
---
...
There are two endpoints which can be used to retrieve data about the running NexaDash instance:
