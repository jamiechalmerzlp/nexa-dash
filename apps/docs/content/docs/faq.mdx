...
[`NEXADASH_ALWAYS_SHOW_PERCENTAGES`](./configuration/basic#nexadash_always_show_percentages) for that.
...
manually, using the [`NEXADASH_USE_NETWORK_INTERFACE`](./configuration/network#nexadash_use_network_interface) flag.
...
## Can you use NexaDash without mounting the whole host drive?
...
please create a [new Issue on GitHub](https://github.com/jamiechalmerzlp/nexa-dash/issues).
