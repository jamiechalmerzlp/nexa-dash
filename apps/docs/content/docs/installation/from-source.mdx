---
title: From Source
description: How to install and configure NexaDash from source
tags:
  - Installation
  - Configuration
  - Source
...
- [speedtest](https://www.speedtest.net/apps/cli) (recommended)
  ...
  - or alternatively: [use local file](../configuration/network#nexadash_speed_test_from_path)
</Step>
<Step>
## Setup
...
You can update your NexaDash instance, by stopping your instance, then
