...
### `NEXADASH_FS_DEVICE_FILTER`

To hide specific drives, you can pass the device names as a string list using this parameter.
If you don't know the device names of your drives, have a look at the log of NexaDash and look for the `Static Server Info -> storage` output.
...
### `NEXADASH_FS_TYPE_FILTER`

If NexaDash detects network drives as internal drives, you can provide a list of ignored FS types here.
Please also create a [bug ticket](https://github.com/jamiechalmerzlp/nexa-dash/issues/new/choose) on the
...
### `NEXADASH_STORAGE_WIDGET_ITEMS_PER_PAGE`
...
### `NEXADASH_STORAGE_WIDGET_MIN_WIDTH`
...
### `NEXADASH_STORAGE_POLL_INTERVAL`
...
### `NEXADASH_OVERRIDE_STORAGE_BRANDS`
...
### `NEXADASH_OVERRIDE_STORAGE_SIZES`
...
### `NEXADASH_OVERRIDE_STORAGE_TYPES`
