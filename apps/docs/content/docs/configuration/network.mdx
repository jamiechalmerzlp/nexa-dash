...
### `NEXADASH_USE_NETWORK_INTERFACE`

If NexaDash detects the wrong gateway as your default interface, you can provide a name here that is used instead.

- type: `string`
- default: `unset`

### `NEXADASH_SPEED_TEST_FROM_PATH`

You can provide a local file-path from where NexaDash should read its speed-test results.
...
If you are running NexaDash using Docker, you will have to prepend your file path with `/mnt/host`
</Callout>

- type: `string`
- default: `unset`

### `NEXADASH_NETWORK_SPEED_AS_BYTES`
...
### `NEXADASH_SPEED_TEST_INTERVAL_CRON`

At which interval the network speed-test should be rerun, passed as a cron string.
This setting overrides `NEXADASH_SPEED_TEST_INTERVAL` if set.
...
### `NEXADASH_NETWORK_WIDGET_MIN_WIDTH`
...
### `NEXADASH_NETWORK_SHOWN_DATAPOINTS`
...
### `NEXADASH_NETWORK_POLL_INTERVAL`
...
### `NEXADASH_OVERRIDE_NETWORK_TYPE`

- type: `string`
- default: `unset`

### `NEXADASH_OVERRIDE_NETWORK_SPEED_UP`
...
### `NEXADASH_OVERRIDE_NETWORK_SPEED_DOWN`
...
### `NEXADASH_OVERRIDE_NETWORK_INTERFACE_SPEED`
...
### `NEXADASH_OVERRIDE_NETWORK_PUBLIC_IP`
